...
Model md = new Model();
md = write.readcontent(board_num);
%>
<%
...
%>
	...
	<div class="boardshape">
		<div class="detailshape">
			...
			<div class="boardlist">
				<form name="bd" action="processwriteupdate.jsp" method="post">
					<input type="hidden" name="board_num" value="<%= md.getBoard_num() %>">
					<input type="text" name="board_title" placeholder="제목을 입력하세요" value="<%= md.getBoard_title() %>" class="contenttitle"><hr>
					<textarea class="content" name="board_content"><%= md.getBoard_content() %></textarea><br>
