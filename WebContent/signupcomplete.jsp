...
<section>
	<div class="loginok">
		<form>
			<div class="loginokinfo">회원가입이 완료되었습니다.</div>
			<br>
			<input type="submit" value="로그인 하러가기" class="loginbox" formaction="login.jsp" formmethod="post"><br>
			<input type="submit" value="홈으로 이동하기" class="homebox" formaction="index.jsp" formmethod="post">
			<div class="joinimage">
