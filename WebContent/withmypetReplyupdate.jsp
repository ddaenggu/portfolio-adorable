...
<img src="image/withmypetlogo.png" width="100%">
	...
	<div class="boardshape">
		<div class="detailshape">
			...
			<div class="boardlist">
				<form name="bd" action="replyUpdatePro.board" method="post">
				<input type="hidden" name="reply_num" value="<%= article.getReply_num() %>">
				<input type="hidden" name="board_num" value="<%= article.getBoard_num() %>">
				<input type="hidden" name="page" value="<%= nowPage %>">
				<input type="text" name="reply_content" class="replyupdatebox" value="<%=article.getReply_content() %>" placeholder="댓글을 입력해주세요"><br>
