...
<header>
		<div class="fixtitle">
			<div class="menu">
				<ul>
					<li class="menudetail"><a href="login.jsp">LOGIN</a></li>
					<li> | </li>
					<li class="menudetail"><a href="signup.jsp">JOINUS</a></li>
					<li> | </li>
					<li class="menudetail"><a href="login.jsp">CART</a></li>
					<li> | </li>
					<li class="menudetail"><a href="login.jsp">MYPAGE</a></li>
				</ul>
			</div>
			<div class="title">
				...
				<div class="list">
					<ul class="mainlist">
						...
						<li><a href="login.jsp" class="ml7">RECOMMEND</a></li>
