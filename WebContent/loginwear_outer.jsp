	...
	<section>
		<div class="productbanner1">
				...
				<ul>
					...
					<li> > </li>
					<li class="podetail"><a href="selectouter.prod">OUTER</a></li>
					<li> > </li>
				...
				<ul>
					<li class="podetail"><a href="selectouter.prod">신상품</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectouterorderbyname.prod">상품명</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectouterorderbypricedesc.prod">높은가격순</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectouterorderbyprice.prod">낮은가격순</a></li>
				</ul>
				</div>
				</div>
