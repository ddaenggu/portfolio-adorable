...
%>
	...
	<form action="roomsearch.jsp" method="post" name="hotel">
	<div class="selectzone">
	<ul>
	<li>
	<div class="selecttitle">체크 인</div>
	<input type="date" name="checkin_date" class="datebox1" id="checkin">
	</li>
	<li>
	<div class="selecttitle">체크 아웃</div>
	<input type="date" name="checkout_date" class="datebox2" id="checkout">
	</li>
	<li>
	...
	<input type="submit" value="검색" class="searchbtn" onclick="return checkdate()">
	</div>
