...
%>
	...
	<section>
		<div class="productbanner1">
				...
				<ul>
					<li class="podetail"><a href="selectallwear.prod">신상품</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectallwearorderbyname.prod">상품명</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectallwearorderbypricedesc.prod">높은가격순</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectallwearorderbyprice.prod">낮은가격순</a></li>
				</ul>
				</div>
				</div>
