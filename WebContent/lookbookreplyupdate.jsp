...
%>
	...
	<a href="lookbook.jsp"><img src="image/lookbooklogo.jpg" width="100%"></a>
		...
		<form name="lb" action="processlookbookreplyupdate.jsp" method="post">
		...
		댓글 수정 <br>
		<input type="text" name="reply_content" value="<%= reply_content %>" class="replytxt">
		<input type="submit" value="수정하기" class="replybtn">
		</div>
		</form>
		</div>
	</section>
