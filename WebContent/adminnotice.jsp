	...
	<div class="boardshape">
				...
				<table class="boardtable">
					...
					%>
						<tr>
							...
							<td class="th_title"><a href="adminNoticeBoardSelect.board?board_num=<%= articleList.get(i).getBoard_num() %>&page=<%= nowPage %>"><%= articleList.get(i).getBoard_title() %></a></td>
		...
		<%} %>
					...
					<div class="boardwrite">
						<button class="write" onclick="location.href='writetonotice.jsp'">글쓰기</button>
					</div>
