	...
	<section>
		<div class="productbanner1">
				...
				<ul>
					...
					<li> > </li>
					<li class="podetail"><a href="selectacc.prod">ACCESSORY</a></li>
					<li> > </li>
				...
				<ul>
					<li class="podetail"><a href="selectacc.prod">신상품</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectaccorderbyname.prod">상품명</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectaccorderbypricedesc.prod">높은가격순</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectaccorderbyprice.prod">낮은가격순</a></li>
				</ul>
				</div>
				</div>
