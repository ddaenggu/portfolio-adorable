...
%>
	...
	<section>
	<div class="loginok">
		<form action="myreservation.jsp" method="post">
			<div class="loginokinfo">예약이 완료되었습니다.</div>
			<br>
			<input type="submit" value="예약확인하기" class="loginbox"><br>
			<input type="button" value="홈으로가기" class="homebox" onclick="location.href='index.jsp'">
			<div class="joinimage">
