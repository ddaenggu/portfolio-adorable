...
<img src="image/withmypetlogo.png" width="100%">
	...
	<div class="boardshape">
		<div class="detailshape">
			...
			<div class="boardlist">
				<form name="bd" action="boardWritePro.board" method="post" enctype="multipart/form-data">
					<input type="text" name="board_title" placeholder="제목을 입력하세요" class="contenttitle"><hr>
					<textarea class="content" name="board_content"></textarea>
					<div class="filezone">
					<label for="fileupload" class="filebox">파일업로드</label><input type="file" id="fileupload" name="board_img">
					</div>
