...
ArrayList<Model> arr = bd.selectMydailyContent(id);
%>
	<header>
		<div class="fixtitle">
			<div class="menu">
			...
			<div class="boardlist">
				...
				<div class="boardbottom">
					...
					<div class="boardmywriting">
						<button class="lookmywriting" onclick="location.href='loingdailyBoard.jsp'">내글보기</button>
					</div>
				</div>
