...
<jsp:useBean id="mypet" class="controller.MypetController"/>
	...
	<div class="mypage">
		<div class="mypageshape">
			...
			ArrayList<ModelMypet> arr = mypet.selectList(mm);
			ArrayList<ModelMypet> friendlist = mypet.selectFriend(id);
			ArrayList<ModelMypet> rq = mypet.selectRequest(id);
			if (!arr.isEmpty()) {
				%>
			...
			<div class="subtop">
			<div class="subbtn2">
			<a href="friendlist.jsp">나의 친구 : <%= friendlist.size() %> 명</a>
			</div>
			<%
			if (!rq.isEmpty()) {
				%>
			<div class="subbtn">
			<a href="friendrequest.jsp">친구 요청</a>
			</div>
				<%
			}
			%>
			...
			<div class="writeleft">
			<input type="button" value="기록하기" class="writebtn" onclick="location.href='mypetwrite.jsp'">
			</div>
