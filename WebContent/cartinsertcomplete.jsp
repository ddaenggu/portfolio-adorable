...
%>
	...
	<div class="loginok">
		<form action="index.jsp" method="post">
			<div class="loginokinfo">장바구니에 상품이 담겼습니다.</div>
			<br>
			<input type="button" value="장바구니이동" class="loginbox" onclick="location.href='selectcart.prod'"><br>
			<input type="submit" value="쇼핑하러가기" class="homebox">
			<div class="joinimage">
