...
%>
	...
	<section>
		<div class="productbanner1">
				<div class="bp"><a href="selectalltoy.prod">TOY</a></div>
				<div class="bp_1">
				<ul>
					<li class="podetail"><a href="#">봉제장난감</a></li>
					<li> | </li>
					<li class="podetail"><a href="#">낚시대</a></li>
					<li> | </li>
					<li class="podetail"><a href="#">스크래쳐</a></li>
					<li> | </li>
				</ul>
				</div>
				...
				%>
				<ul>
					<li class="podetail"><a href="selectalltoy.prod">TOY</a></li>
					<li> > </li>
				...
				<ul>
					<li class="podetail"><a href="selectalltoy.prod">신상품</a></li>
					<li> | </li>
					<li class="podetail"><a href="#">상품명</a></li>
					<li> | </li>
					<li class="podetail"><a href="#">높은가격순</a></li>
					<li> | </li>
					<li class="podetail"><a href="#">낮은가격순</a></li>
				</ul>
				</div>
				</div>
