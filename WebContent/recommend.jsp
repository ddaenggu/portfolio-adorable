...
%>
	...
	<section>
		<div class="productbanner1">
				<div class="bp"><a href="selectrecommend.prod">RECOMMEND</a></div>
				...
				%>
				<ul>
					<li class="podetail"><a href="selectrecommend.prod">RECOMMEND</a></li>
					<li> > </li>
				...
				<ul>
					<li class="podetail"><a href="selectrecommend.prod">신상품</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectrecommendorderbyname.prod">상품명</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectrecommendorderbypricedesc.prod">높은가격순</a></li>
					<li> | </li>
					<li class="podetail"><a href="selectrecommendorderbyprice.prod">낮은가격순</a></li>
				</ul>
				</div>
				</div>
